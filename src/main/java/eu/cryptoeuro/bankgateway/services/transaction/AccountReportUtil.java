...
public class AccountReportUtil {
    ...
    public static List<Transaction> parseTransaction(ReportEntry2 entry) {
    ...
    private static Transaction parseTransactionDetails(EntryTransaction2 details, ReportEntry2 entry) {
